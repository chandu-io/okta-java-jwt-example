...
public class JWTSignWithHS256AlgoDemoTest {
	...
	public void createAndDecodeJWT() {
		...
		final var jwt = JWTSignWithHS256AlgoDemo.createJWT(
				jwtId, // claim = jti
				jwtIssuer, // claim = iss
		...
		final var claims = JWTSignWithHS256AlgoDemo.decodeJWT(jwt);
	...
	public void decodeShouldFail() {
		...
		assertThrows(MalformedJwtException.class, () -> JWTSignWithHS256AlgoDemo.decodeJWT(notAJwt));
	...
	public void createAndDecodeTamperedJWT() {
		...
		assertThrows(SignatureException.class, () -> JWTSignWithHS256AlgoDemo.decodeJWT(tamperedJwt));
